/*
 * ******************************************************** *
 * Created Date: Tuesday, 26th November 2019 9:25:15 pm     *
...
function Slider_Controller() {
  ...
  this.addNextAnimationClass = function(direction) {
    ...
    this.segmentContainer.classList.add(
      `slide-${this.currentSegmentOnScreen}-${direction}`
    );
  };
  ...
  this.playAnimationsAutomatically = function() {
    this.timeoutID = setTimeout(
      ...
      this.animationDelayInSeconds * 1000
    );
  };
